...
def reset_service() -> None:
    import app.main
    app.main.service = BookmarkService()
...
def test_create_bookmark_returns_201_and_public_model(client: TestClient) -> None:
...
def test_create_bookmark_defaults_tags_to_empty_list(client: TestClient) -> None:
...
def test_list_bookmarks_filters_by_exact_tag(client: TestClient) -> None:
...
def test_get_bookmark_returns_single_bookmark(client: TestClient) -> None:
...
def test_delete_bookmark_returns_204_and_removes_it(client: TestClient) -> None:
    created = client.post("/bookmarks", json=valid_payload()).json()
